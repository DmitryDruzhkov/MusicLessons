import { YCoordinates } from '../shared/constants';
import { ElementTypes, Notes, TaskDND, TaskDNDOld } from '../shared/interfaces';

export const taskDND: TaskDND[] = [
  {
...
export const tasksDNDOld: TaskDNDOld[] = [
  {
    title: 'Соль мажор',
    elements: [
